...
function LoginONG(){
    ...
    function showKey(){
        const eye = document.getElementsByClassName('hideeyeONG')[0]
        ...
        <>
            ...
            <Container>
                    <WelcomeBox>
                        ...
                        <WelcomeMessage>Seja a mudança que transforma realidades.</WelcomeMessage>
                    </WelcomeBox>
                    <LoginBox>
                        ...
                        <FormLogin>
                            ...
                            <ContainerCampo>
                                ...
                                <span onClick={()=>{
                                    showKey()
                                }} className='material-symbols-outlined hideeyeONG'>
                                    visibility_off
                                </span>
                            </ContainerCampo>
                            <Entrar onClick={()=>{
